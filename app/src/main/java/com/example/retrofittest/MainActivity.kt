package com.cursosandroidant.retrofittest
...
import com.example.retrofittest.retro.LoginResponse
import com.example.retrofittest.retro.LoginService
import com.example.retrofittest.retro.UserInfo
        ...
        service.login(UserInfo(email,password)).enqueue(
            ...
            updateUI("${Constants.TOKEN_PROPERTY}: ${result?.token}")
                ...
                override fun onFailure(call: Call<LoginResponse>, t: Throwable) {
                    Log.e("Retro","Problemas con el servidor")
                }
            }
        )
